...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pypher-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15168&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pypher-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pypher` can be installed with:

```
conda install pypher
```

It is possible to list all of the versions of `pypher` available on your platform with:
